...
import 'package:cooking_recipe_app/src/components/image_picker_widget.dart';
import 'package:cooking_recipe_app/src/components/ingredient_widget.dart';
...
class AddRecipePage extends StatefulWidget {
  ...
  final Recipe recipe;
  AddRecipePage(this.serverController, {Key key, this.recipe}) : super(key: key);
...
class _AddRecipePageState extends State<AddRecipePage> {
              ...
              child: Card(
                ...
                child: Padding(
                  ...
                  child: ListView(children: <Widget>[
                    TextFormField(
                      initialValue: name,
                      decoration: InputDecoration(labelText: "Nombre de receta"),
                      onSaved: (value) {
                        this.name = value;
                      },
                      validator: (value) {
  ...
  void _ingredientDialog(BuildContext context, {String ingredient, int index}) {
    ...
    showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            title: Text(editing ? "Editando ingrediente" : "Agregando ingrediente"),
            content: TextField(
