...
void generateData(BuildContext context) {
  ...
  users = [
    ...
    User(id: 12, nickname: "LuzAlf", password: "luz", genrer: Genrer.FEMALE, photo: AssetFile(assetBundle, "assets/images/usuarios/img14.jpg")),
    User(
        id: 13,
    ...
    User(id: 14, nickname: "SuyinHu", password: "suyin", genrer: Genrer.FEMALE, photo: AssetFile(assetBundle, "assets/images/usuarios/img16.jpg")),
    User(
        id: 15,
    ...
    User(id: 16, nickname: "LuisaMagañ", password: "luisa", genrer: Genrer.FEMALE, photo: AssetFile(assetBundle, "assets/images/usuarios/img18.jpg")),
    User(
        id: 17, nickname: "Yakinawa", password: "yakinawa", genrer: Genrer.FEMALE, photo: AssetFile(assetBundle, "assets/images/usuarios/img19.jpg")),
    User(id: 18, nickname: "LuisEnrique", password: "luis", genrer: Genrer.MALE, photo: AssetFile(assetBundle, "assets/images/usuarios/img20.jpg")),
  ];

  recipes = <Recipe>[
    Recipe(
        description: "Es una receta muy sencilla, su nivel de dificultad es de casi cero "
        ...
        user: users[0],
        photo: AssetFile(assetBundle, "assets/images/platillos/pollo-empanizado.jpg")),
    Recipe(
    ...
    Recipe(
        ...
        user: users[6],
        photo: AssetFile(assetBundle, "assets/images/platillos/escabeche-salvadoreno.jpg")),
    Recipe(
        ...
        date: DateTime.now(),
        id: 6,
        ingredients: <String>["Plátanos maduros", "Maicena", "Leche", "Ramas de canela", "Frijoles refritos", "Azúcar", "Aceite"],
        steps: <String>[
        ...
        user: users[9],
        photo: AssetFile(assetBundle, "assets/images/platillos/empanadas-salvadorenas.jpg")),
    Recipe(
        name: "Sopa de tortillas",
        description:
            "La sopa de tortillas es uno de los platos favoritos de los salvadoreños por ser relativamente fácil a la hora de preparar, rinde lo suficiente y es ideal para compartir con gran parte de la familia, los ingredientes son accesibles  y es súper deliciosa.",
        ...
        user: users[9],
        photo: AssetFile(assetBundle, "assets/images/platillos/empanadas-argentinas.jpg")),
  ];
}
